...
def learn_dt(input_args):
    ...
    env_task_metadata = {"mode": "train", "marker_prob": 1, "hash_info": 'run2_pytorch-a2c-ppo-acktr-gail/tasks/topOff_all_states_w_12.pkl', 'train_configs': topOff_config, 'test_configs': 1 - topOff_config}
